...
export default function Notfound() {
  return <>
  <Helmet><title>Not found page</title></Helmet>
    <div className="lg:px-20 container px-10 mx-auto">
      <div className="lg:gap-5 flex flex-col justify-center w-full h-screen gap-10">
        <div >
          <Link to="/"><img src={logo} alt="freshCart-log" /></Link>
        </div>
        <div className="lg:flex-row lg:items-center flex flex-col items-start justify-between"><div>
          ...
          <div className="lg:mb-0 flex gap-5 mb-10">
            ...
            <Link to="/" className="hover:bg-[#088A08] focus:ring-[#6cce6c] sm:w-auto w-full px-[17px] py-[9px] font-semibold text-center text-white transition-all duration-300 bg-[#0AAD0A] rounded-md whitespace-nowrap" >Back to Home</Link>        </div>
        </div>
          <div><img src={error} alt="error-img" /></div>
        </div>
      </div>
    </div>
