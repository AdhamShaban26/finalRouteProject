          ...
          <div ref={modalRef} className="relative bg-white rounded-lg shadow">
            ...
            <div className="flex items-center justify-between gap-12 p-4 space-y-4">
              <div className="pl-2 mt-8">
                <p className="sm:text-5xl text-3xl font-semibold text-[#0AAD0A]">
                  {name}
                </p>
            ...
            <div className="flex items-center justify-end p-4 border-t border-gray-200 rounded-b">
              <button
                onClick={hideModal}
                type="button"
                className="text-white bg-[#0AAD0A] hover:bg-[#088A08]  focus:ring-4 focus:outline-none focus:ring-[#6cce6c] font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                close
              </button>
            </div>
